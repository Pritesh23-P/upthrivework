...
const navigation = [
  {
    title: 'Work',
    links: [
      { title: 'fullstack', href: '/work/fullstack' },
      { title: 'dissertation', href: '/work/dissertation' },
      { title: 'aiml', href: '/work/aiml' },
      {
        title: (
          <>
  ...
  return (
    <form className="max-w-sm">
      ...
      <p className="mt-4 text-sm text-neutral-700">
        Subscribe to get the latest academic tips, guides, and exclusive
      ...
      <FadeIn>
        ...
        <div className="mt-24 mb-20 flex flex-wrap items-end justify-between gap-x-6 gap-y-4 border-t border-neutral-950/10 pt-12">
          ...
          <p className="text-sm text-neutral-700">
            © UpthriveWork Hub. All rights reserved. {new Date().getFullYear()}
          </p>
        </div>
      </FadeIn>
    </Container>
