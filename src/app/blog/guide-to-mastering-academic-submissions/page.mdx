export const article = {
  ...
  author: {
    ...
    image: { src: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Aidan' },
  },
}
...
export const metadata = {
  ...
  openGraph: {
    title: article.title,
    description: article.description,
    url: 'https://upthrivewerk.com/blog/guide-to-mastering-academic-submissions',
    type: 'article',
  },
  twitter: {
    title: article.title,
  ...
  alternates: {
    canonical: 'https://upthrivewerk.com/blog/guide-to-mastering-academic-submissions',
  },
}
